...
/**
 * the element date is an inline element to identify a date expressed in the text and to propose a<br/> normalized representation in the date attribute.
...
// CONSTRUCTORS ------------------
     ...
     */
    public Date(DateSimpleType dateAttr) {
        this();
     ...
     */
    public Date dateAttr(final DateSimpleType dateAttr) {
        setDateAttr(dateAttr);
        return this;
    }
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Date</code> instance
     */
    public Date langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date spaceAttr(final NCNameSimpleType spaceAttr) {
