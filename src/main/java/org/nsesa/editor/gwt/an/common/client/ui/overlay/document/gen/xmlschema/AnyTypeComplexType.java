...
public class AnyTypeComplexType extends OverlayWidgetImpl {
    ...
    private static StructureIndicator STRUCTURE_INDICATOR = new StructureIndicator.DefaultStructureIndicator(1, 1
            ,
            new StructureIndicator.DefaultSequence(1, 1, new StructureIndicator.DefaultWildcard(0, -1)
            )
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "anyTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>AnyTypeComplexType</code> object with the given DOM element
     */
