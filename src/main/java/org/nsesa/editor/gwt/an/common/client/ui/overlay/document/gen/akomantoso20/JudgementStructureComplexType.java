...
/**
 * the type judgementStructure specifies the overall content model of the document types that<br/> describe judgements
...
// CONSTRUCTORS ------------------
    ...
    public Header getHeader() {
        Header result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Header".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public JudgementBody getJudgementBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("JudgementBody".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
