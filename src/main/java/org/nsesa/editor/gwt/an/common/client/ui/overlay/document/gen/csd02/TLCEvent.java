...
/**
 * The element TLCEvent is a metadata reference to the Akoma Ntoso URI of an ontology instance of the<br/> class Event
...
public class TLCEvent extends ReferenceTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "TLCEvent");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>TLCEvent</code> object and set up its type
     */
    public TLCEvent() {
        super(create());
        setType("TLCEvent");
     ...
     */
    public TLCEvent(AnyURISimpleType hrefAttr, IDSimpleType idAttr, StringSimpleType showAsAttr) {
        this();
    ...
    /**
     * Create a <code>TLCEvent</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> TLCEvent</code> instance
     */
