...
public class FRBRuri extends ValueTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "FRBRuri");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public FRBRuri refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> FRBRuri</code> instance
     */
    public FRBRuri shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRuri</code> instance
     */
    public FRBRuri showAsAttr(final StringSimpleType showAsAttr) {
