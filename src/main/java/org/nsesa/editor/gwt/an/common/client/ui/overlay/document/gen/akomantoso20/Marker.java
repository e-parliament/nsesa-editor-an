...
import org.nsesa.editor.gwt.an.common.client.ui.overlay.document.gen.akomantoso20.MarkerreqComplexType;
...
/**
* the element marker is a generic element for a marker. It can be placed in a block instead of<br/> any of the other markers. The attribute name is required and gives a name to the element.
...
span.setClassName("widget marker");
return span;
}
