...
/**
 * The element quantity is an inline element to identify a text fragment introducing or referring<br/> to a quantity. This could be a dimensionless number, or a number referring to a length, weight,<br/> duration, etc. or even a sum of money. The attribute normalized contains the value normalized in a<br/> number, if appropriate.
