...
/**
 * this element is a hierarchical container called "point" either explicitly or due to the local<br/> tradition
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Point</code> instance
     */
    public Point langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Point</code> instance
     */
    public Point spaceAttr(final NCNameSimpleType spaceAttr) {
