...
/**
 * The element a is an HTML element and is used in Akoma Ntoso as in HTML, for the generic link to<br/> a web resource (NOT to an Akoma Ntoso document: use ref for that). It is an inline.
