...
/**
 * The complex type Amendments is a list of all the amendment elements that can be used on a<br/> document analysis
...
// FIELDS ------------------
    ...
    public java.util.List<TextualMod> getTextualMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TextualMod".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<MeaningMod> getMeaningMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("MeaningMod".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ScopeMod> getScopeMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ScopeMod".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ForceMod> getForceMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ForceMod".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<EfficacyMod> getEfficacyMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("EfficacyMod".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<LegalSystemMod> getLegalSystemMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("LegalSystemMod".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
