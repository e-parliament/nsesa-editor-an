...
public class JudgmentStructureComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "judgmentStructureComplexType");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05");
        span.setClassName("widget judgmentStructureComplexType");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>JudgmentStructureComplexType</code> object with the given DOM element
     */
    public JudgmentStructureComplexType(Element element) {
        super(element);
    }
     ...
     *
     * @param containsAttr the new value
     * @return <code>JudgmentStructureComplexType</code> instance
     */
    public JudgmentStructureComplexType containsAttr(final VersionTypeSimpleType containsAttr) {
     ...
     * @return <code>JudgmentStructureComplexType</code> instance
     */
    public JudgmentStructureComplexType nameAttr(final StringSimpleType nameAttr) {
    ...
    public CoverPage getCoverPage() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("CoverPage".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Header getHeader() {
        Header result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Header".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Add <code>JudgmentBody</code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public JudgmentBody getJudgmentBody() {
        JudgmentBody result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("JudgmentBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result = (JudgmentBody) widget;
                break;
            }
        }
        return result;
    ...
    /**
     * Set <code>judgmentBodyElem</code> property in DSL way
     *
     * @param judgmentBodyElem new value
     * @return <code>JudgmentBody</code> instance
     */
    public JudgmentBody setJudgmentBody(JudgmentBody judgmentBodyElem) {
        JudgmentBody result = getJudgmentBody();
        // remove the child of the same type if exist
        if (result != null) {
            this.removeOverlayWidget(result);
        }
        this.addOverlayWidget(judgmentBodyElem);

        return judgmentBodyElem;
    }
    ...
    public Conclusions getConclusions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Conclusions".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Attachments getAttachments() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Attachments".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public JudgmentStructureComplexType html(String s) {
        super.html(s);
        return this;
    }
}
