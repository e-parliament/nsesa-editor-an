...
/**
 * this element is a hierarchical container called "clause" either explicitly or due to the local<br/> tradition
...
public class Clause extends HierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "clause");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Clause</code> object and set up its type
     */
    public Clause() {
        super(create());
        setType("clause");
     ...
     */
    public Clause(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Clause</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Clause</code> instance
     */
    public Clause spaceAttr(final NCNameSimpleType spaceAttr) {
