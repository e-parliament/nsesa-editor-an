...
public class AmendmentBody extends AmendmentBodyTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "amendmentBody");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> AmendmentBody</code> instance
     */
    public AmendmentBody langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> AmendmentBody</code> instance
     */
    public AmendmentBody spaceAttr(final StringSimpleType spaceAttr) {
