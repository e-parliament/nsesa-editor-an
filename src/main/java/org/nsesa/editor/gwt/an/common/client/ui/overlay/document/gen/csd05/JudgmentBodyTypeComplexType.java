...
public class JudgmentBodyTypeComplexType extends OverlayWidgetImpl {
    ...
    private static StructureIndicator STRUCTURE_INDICATOR = new StructureIndicator.DefaultStructureIndicator(1, 1
            ...
            new StructureIndicator.DefaultSequence(1, -1, new StructureIndicator.DefaultGroup(1, 1, new StructureIndicator.DefaultChoice(1, 1, new StructureIndicator.DefaultElement(1, 1, new Introduction())
                    ...
                    , new StructureIndicator.DefaultElement(1, 1, new Arguments())
                    , new StructureIndicator.DefaultElement(1, 1, new Remedies())
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "judgmentBodyTypeComplexType");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05");
        span.setClassName("widget judgmentBodyTypeComplexType");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>JudgmentBodyTypeComplexType</code> object with the given DOM element
     */
    public JudgmentBodyTypeComplexType(Element element) {
        super(element);
    }
     ...
     *
     * @param alternativeToAttr the new value
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType wildcardContentAttr(final String wildcardContentAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code>JudgmentBodyTypeComplexType</code> instance
     */
    public JudgmentBodyTypeComplexType periodAttr(final AnyURISimpleType periodAttr) {
    ...
    public java.util.List<Introduction> getIntroductions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Introduction".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Background> getBackgrounds() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Background".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Return <code>java.util.List<Arguments></code> property
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Arguments> getArgumentses() {
        java.util.List<Arguments> result = new ArrayList<Arguments>();
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Arguments".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((Arguments) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    }
    ...
    /**
     * Return <code>java.util.List<Arguments></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Arguments> getArgumentsList() {
        return getArgumentses();
    }

    /**
     * Add <code>java.util.List<Arguments></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Arguments addArguments(Arguments argumentsElem) {
        this.addOverlayWidget(argumentsElem);
        return argumentsElem;
    }

    /**
     * Return <code>java.util.List<Remedies></code> property
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Remedies> getRemedieses() {
        java.util.List<Remedies> result = new ArrayList<Remedies>();
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Remedies".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((Remedies) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    }
    ...
    /**
     * Return <code>java.util.List<Remedies></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Remedies> getRemediesList() {
        return getRemedieses();
    }

    /**
     * Add <code>java.util.List<Remedies></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Remedies addRemedies(Remedies remediesElem) {
        this.addOverlayWidget(remediesElem);
        return remediesElem;
    }
    ...
    public java.util.List<Motivation> getMotivations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Motivation".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Decision> getDecisions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Decision".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public JudgmentBodyTypeComplexType html(String s) {
        super.html(s);
        return this;
    }
}
