...
/**
 * the element docCommittee is an inline element within preface to identify the string used by the<br/> document detailing the committee within which the document originated
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocCommittee</code> instance
     */
    public DocCommittee spaceAttr(final NCNameSimpleType spaceAttr) {
