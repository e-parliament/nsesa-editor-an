...
public class Recitals extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "recitals");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Recitals</code> object and set up its type
     */
    public Recitals() {
        super(create());
        setType("recitals");
    ...
    /**
     * Create a <code>Recitals</code> object with the given DOM element
     */
