...
public class Adjournment extends AlthierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("type", "adjournment");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Adjournment</code> instance
     */
    public Adjournment langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Adjournment</code> instance
     */
    public Adjournment spaceAttr(final StringSimpleType spaceAttr) {
