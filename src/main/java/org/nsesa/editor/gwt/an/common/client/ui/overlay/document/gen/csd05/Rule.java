...
public class Rule extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Rule</code> object and set up its type
     */
    public Rule() {
        super(create());
        setType("rule");
     ...
     */
    public Rule(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Rule</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Rule alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Rule</code> instance
     */
    public Rule langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Rule</code> instance
     */
    public Rule wildcardContentAttr(final String wildcardContentAttr) {
