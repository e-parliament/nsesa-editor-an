...
/**
 * this element is a structural container for parts of a debates that are relevant to the notices of<br/> motions
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class NoticesOfMotion extends AlthierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "noticesOfMotion");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
        span.setClassName("widget noticesOfMotion");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>NoticesOfMotion</code> object and set up its type
     */
    public NoticesOfMotion() {
        super(create());
        setType("noticesOfMotion");
    }

    /**
     * Constructor with required attributes
     */
    public NoticesOfMotion(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>NoticesOfMotion</code> object with the given DOM element
     */
    public NoticesOfMotion(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public NoticesOfMotion alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> NoticesOfMotion</code> instance
     */
    public NoticesOfMotion wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public NoticesOfMotion html(String s) {
        super.html(s);
        return this;
    }
}
