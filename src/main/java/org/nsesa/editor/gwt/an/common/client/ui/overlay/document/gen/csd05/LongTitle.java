...
public class LongTitle extends BlocksreqComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "longTitle");
...
// CONSTRUCTORS ------------------
     ...
     */
    public LongTitle(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> LongTitle</code> instance
     */
    public LongTitle langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> LongTitle</code> instance
     */
    public LongTitle spaceAttr(final StringSimpleType spaceAttr) {
