...
public class Proviso extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Proviso</code> object and set up its type
     */
    public Proviso() {
        super(create());
        setType("proviso");
     ...
     */
    public Proviso(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Proviso</code> object with the given DOM element
     */
    public Proviso(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Proviso alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Proviso</code> instance
     */
    public Proviso wildcardContentAttr(final String wildcardContentAttr) {
