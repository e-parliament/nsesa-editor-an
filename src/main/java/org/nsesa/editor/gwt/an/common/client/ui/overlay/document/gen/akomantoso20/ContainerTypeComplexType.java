...
/**
 * the complex type containerType is the content model for the generic element for a container. It<br/> can be placed in a container instead of any of the other containers. The attribute name is required<br/> and gives a name to the element.
