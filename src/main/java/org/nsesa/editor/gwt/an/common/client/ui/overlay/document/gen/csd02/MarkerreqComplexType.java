...
/**
 * the complex type markerreq defines the content model and attributes shared by all marker elements.<br/> Here the id attribute is required
...
public class MarkerreqComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "markerreqComplexType");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>MarkerreqComplexType</code> object with the given DOM element
     */
     ...
     * @return <code>MarkerreqComplexType</code> instance
     */
    public MarkerreqComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public MarkerreqComplexType html(String s) {
        super.html(s);
        return this;
    }
}
