...
/**
 * the complex type markeropt defines the content model and attributes shared by all marker elements.<br/> Here the id attribute is optional
...
public class MarkeroptComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "markeroptComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>MarkeroptComplexType</code> instance
     */
    public MarkeroptComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
