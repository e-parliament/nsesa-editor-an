...
/**
 * the element docType is an inline element within preface to identify the string used by the document<br/> for its own type
...
public class DocType extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "docType");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocType</code> instance
     */
    public DocType spaceAttr(final NCNameSimpleType spaceAttr) {
