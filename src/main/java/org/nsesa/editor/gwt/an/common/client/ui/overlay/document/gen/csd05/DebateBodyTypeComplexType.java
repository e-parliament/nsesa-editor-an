...
public class DebateBodyTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "debateBodyTypeComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>DebateBodyTypeComplexType</code> instance
     */
    public DebateBodyTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>DebateBodyTypeComplexType</code> instance
     */
    public DebateBodyTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
