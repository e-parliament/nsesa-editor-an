...
public class BlocksoptComplexType extends OverlayWidgetImpl  {
...
/**
* Create a <code>BlocksoptComplexType</code> object with the given DOM element
*/
...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @param langAttr the new value
        * @return <code>BlocksoptComplexType</code> instance
        */
        ...
        * @return <code>BlocksoptComplexType</code> instance
        */
        public BlocksoptComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
...
*/
@Override
public BlocksoptComplexType html(String s) {
    super.html(s);
    return this;
}
}
