...
import org.nsesa.editor.gwt.an.client.ui.overlay.document.gen.csd02.MaincontentComplexType;
...
/**
* this element is a structural container for the section of a judgement containing the remedies
* This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
*/

public class Remedies extends MaincontentComplexType  {
...
span.setAttribute("type", "remedies");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget remedies");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>Remedies</code> object and set up its type
*/
public Remedies() {
super(create());
setType("remedies");
...
/**
* Create a <code>Remedies</code> object with the given DOM element
*/
public Remedies(Element element) {
super(element);
}
...
//Override all attributes methods to be conformant with DSL approach
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code> Remedies</code> instance
        */
        public Remedies periodAttr(final AnyURISimpleType periodAttr) {
