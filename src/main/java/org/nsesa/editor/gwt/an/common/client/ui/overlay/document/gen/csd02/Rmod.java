...
/**
 * the element rmod is an inline element containing the specification of a range of modifications on<br/> another document
...
public class Rmod extends ModTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "rmod");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Rmod</code> instance
     */
    public Rmod spaceAttr(final NCNameSimpleType spaceAttr) {
