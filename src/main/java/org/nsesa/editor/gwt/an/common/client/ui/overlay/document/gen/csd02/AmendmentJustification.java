...
public class AmendmentJustification extends BlocksoptComplexType  {
...
span.setAttribute("type", "amendmentJustification");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget amendmentJustification");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>AmendmentJustification</code> object and set up its type
*/
public AmendmentJustification() {
super(create());
...
/**
* Create a <code>AmendmentJustification</code> object with the given DOM element
*/
...
//Override all attributes methods to be conformant with DSL approach
        ...
        * @return <code> AmendmentJustification</code> instance
        */
        public AmendmentJustification alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> AmendmentJustification</code> instance
        */
        public AmendmentJustification classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> AmendmentJustification</code> instance
        */
        public AmendmentJustification styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> AmendmentJustification</code> instance
        */
        public AmendmentJustification spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> AmendmentJustification</code> instance
        */
        public AmendmentJustification evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> AmendmentJustification</code> instance
        */
        public AmendmentJustification periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public AmendmentJustification html(String s) {
    super.html(s);
    return this;
}
}
