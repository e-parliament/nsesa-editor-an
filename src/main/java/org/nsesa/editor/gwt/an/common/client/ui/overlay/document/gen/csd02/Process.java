...
/**
 * The element process is an inline element to identify a text fragment introducing or referring to a<br/> process in the ontology
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Process extends InlinereqreqComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("type", "process");
        span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
        span.setClassName("widget process");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Process</code> object and set up its type
     */
    public Process() {
        super(create());
        setType("process");
     ...
     */
    public Process(AnyURISimpleType refersToAttr, IDSimpleType idAttr) {
        this();
    ...
    /**
     * Create a <code>Process</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Process</code> instance
     */
     ...
     * @return <code> Process</code> instance
     */
    public Process classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Process</code> instance
     */
    public Process styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Process</code> instance
     */
    public Process titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Process</code> instance
     */
    public Process wildcardContentAttr(final String wildcardContentAttr) {
     ...
     * @return <code> Process</code> instance
     */
    public Process spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Process</code> instance
     */
    public Process idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Process</code> instance
     */
    public Process periodAttr(final AnyURISimpleType periodAttr) {
