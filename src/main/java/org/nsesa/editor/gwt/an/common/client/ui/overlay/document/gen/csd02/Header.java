...
/**
 * the element header is used as a container of all prefacing material of judgements (e.g. headers,<br/> formulas, etc.)
...
public class Header extends BlocksoptComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "header");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Header</code> object and set up its type
     */
    public Header() {
        super(create());
        setType("header");
    ...
    /**
     * Create a <code>Header</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Header</code> instance
     */
    public Header classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Header</code> instance
     */
    public Header periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Header</code> instance
     */
    public Header spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Header</code> instance
     */
    public Header statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Header</code> instance
     */
    public Header styleAttr(final StringSimpleType styleAttr) {
