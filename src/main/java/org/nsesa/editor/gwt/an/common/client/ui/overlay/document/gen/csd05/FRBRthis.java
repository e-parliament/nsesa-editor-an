...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public FRBRthis refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> FRBRthis</code> instance
     */
    public FRBRthis shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRthis</code> instance
     */
    public FRBRthis showAsAttr(final StringSimpleType showAsAttr) {
