...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public FRBRsubtype refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> FRBRsubtype</code> instance
     */
    public FRBRsubtype shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRsubtype</code> instance
     */
    public FRBRsubtype showAsAttr(final StringSimpleType showAsAttr) {
