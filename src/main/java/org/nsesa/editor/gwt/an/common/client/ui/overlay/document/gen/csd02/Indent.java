...
/**
 * this element is a hierarchical container called "indent" either explicitly or due to the local<br/> tradition
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Indent extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Indent</code> object and set up its type
     */
    public Indent() {
        super(create());
        setType("indent");
     ...
     */
    public Indent(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Indent</code> object with the given DOM element
     */
    public Indent(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Indent refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Indent</code> instance
     */
    public Indent evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent wildcardContentAttr(final String wildcardContentAttr) {
     ...
     * @return <code> Indent</code> instance
     */
    public Indent periodAttr(final AnyURISimpleType periodAttr) {
