...
import org.nsesa.editor.gwt.an.common.client.ui.overlay.document.gen.akomantoso20.ListItemsComplexType;
...
/**
* The element ol is an HTML element and is used in Akoma Ntoso as in HTML, for an ordered list of<br/> list item (elements li)
...
// CONSTRUCTORS ------------------
/**
* Create a <code>Ol</code> object and set up its type
*/
public Ol() {
super(create());
setType("ol");
...
/**
* Create a <code>Ol</code> object with the given DOM element
*/
