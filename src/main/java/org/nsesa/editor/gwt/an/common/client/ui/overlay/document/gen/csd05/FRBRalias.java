...
public class FRBRalias extends ValueTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "FRBRalias");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> FRBRalias</code> instance
     */
    public FRBRalias shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRalias</code> instance
     */
    public FRBRalias showAsAttr(final StringSimpleType showAsAttr) {
