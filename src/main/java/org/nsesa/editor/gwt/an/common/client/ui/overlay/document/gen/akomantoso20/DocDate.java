...
/**
 * the element docDate is an inline element within preface to identify the string used by the<br/> document for its own date(s). Documents with multiple dates may use multiple docDate elements.
