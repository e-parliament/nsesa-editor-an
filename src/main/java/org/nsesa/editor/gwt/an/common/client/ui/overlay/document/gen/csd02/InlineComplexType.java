...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @return <code>InlineComplexType</code> instance
        */
        public InlineComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        */
        ...
        return this;
            ...
            */
            ...
            for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Abbr".equalsIgnoreCase(widget.getType())) {
            ...
            */
            ...
            for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Time".equalsIgnoreCase(widget.getType())) {
            ...
            */
            ...
            for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Br".equalsIgnoreCase(widget.getType())) {
