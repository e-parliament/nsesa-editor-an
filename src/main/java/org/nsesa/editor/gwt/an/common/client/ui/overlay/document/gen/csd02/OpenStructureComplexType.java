...
/**
 * the type openStructure specifies the overall content model of all the document types that do not<br/> have a specific and peculiar structure
...
// CONSTRUCTORS ------------------
    ...
    public MainBody getMainBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("MainBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
