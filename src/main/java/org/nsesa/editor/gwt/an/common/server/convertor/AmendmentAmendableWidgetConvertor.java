 ...
 * @version $Id$
 */
@Component("amendmentAmendableWidgetConvertor")
@Lazy
public class AmendmentAmendableWidgetConvertor implements ValueConverter {
    ...
    public Object convertToDto(Object object, BeanFactory beanFactory) {
        ...
        if (amendmentContainer.getSourceReference() != null) {
            return new AmendableWidgetReference();
        }
        return null;
    }
