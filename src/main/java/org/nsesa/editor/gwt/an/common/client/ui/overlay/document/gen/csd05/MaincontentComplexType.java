...
public class MaincontentComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "maincontentComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>MaincontentComplexType</code> instance
     */
    public MaincontentComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>MaincontentComplexType</code> instance
     */
    public MaincontentComplexType spaceAttr(final StringSimpleType spaceAttr) {
