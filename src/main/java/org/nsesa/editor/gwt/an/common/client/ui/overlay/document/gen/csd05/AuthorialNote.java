...
public class AuthorialNote extends SubFlowStructureComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "authorialNote");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> AuthorialNote</code> instance
     */
    public AuthorialNote langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> AuthorialNote</code> instance
     */
    public AuthorialNote spaceAttr(final StringSimpleType spaceAttr) {
