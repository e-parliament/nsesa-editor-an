...
/**
 * the complex type referenceType defines the empty content model and the list of attributes for<br/> metadata elements in the references section
...
public class ReferenceTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "referenceTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>ReferenceTypeComplexType</code> object with the given DOM element
     */
     ...
     *
     * @param wildcardContentAttr the new value
     * @return <code>ReferenceTypeComplexType</code> instance
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public ReferenceTypeComplexType html(String s) {
        super.html(s);
        return this;
    }
}
