...
/**
 * the element wrap is a concluding element in a hierarchy that contains paragraphs wrapping up<br/> the preceding lower hierarchical elements.
...
public class Wrap extends BlocksoptComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "wrap");
