...
/**
 * the element question is a container of a single official question as proposed by an MP to a person<br/> holding an official position
...
public class Question extends SpeechTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "question");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Question</code> instance
     */
    public Question spaceAttr(final NCNameSimpleType spaceAttr) {
