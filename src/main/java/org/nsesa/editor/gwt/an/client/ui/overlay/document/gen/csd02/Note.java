...
// CONSTRUCTORS ------------------
/**
* Create a <code>Note</code> object and set up its type
*/
public Note() {
super(create());
setType("note");
...
*/
public Note(IDSimpleType idAttr) {
this();
setIdAttr(idAttr);
}
...
/**
* Create a <code>Note</code> object with the given DOM element
*/
...
//Override all attributes methods to be conformant with DSL approach
        ...
        * @return <code> Note</code> instance
        */
        ...
        * @return <code> Note</code> instance
        */
        public Note spaceAttr(final NCNameSimpleType spaceAttr) {
