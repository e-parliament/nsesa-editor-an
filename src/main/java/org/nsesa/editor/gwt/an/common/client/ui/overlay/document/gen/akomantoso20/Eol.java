...
/**
 * the element eol (end of line) is a marker for where in the original text the line breaks. If<br/> the line breaks within a word, place the element BEFORE the word and place the number of characters<br/> before the break in the attribute breakat
...
public class Eol extends EolTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "eol");
