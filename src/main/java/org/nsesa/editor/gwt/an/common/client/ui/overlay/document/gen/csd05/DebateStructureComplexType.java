...
// CONSTRUCTORS ------------------
     ...
     * @return <code>DebateStructureComplexType</code> instance
     */
    public DebateStructureComplexType nameAttr(final StringSimpleType nameAttr) {
    ...
    public DebateBody getDebateBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DebateBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
