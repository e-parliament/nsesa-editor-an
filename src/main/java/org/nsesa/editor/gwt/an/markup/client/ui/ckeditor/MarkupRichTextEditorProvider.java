 ...
 * @version $Id$
 */
public class MarkupRichTextEditorProvider implements Provider<RichTextEditor> {

    @Inject
    MarkupRichTextEditorConfig richTextEditorConfig;

    @Inject
    MarkupRichTextEditorPlugin richTextEditorPlugin;
