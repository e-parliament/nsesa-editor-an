...
/**
 * the complex type prefaceopt defines the content model and attributes used by preface. Here the id<br/> attribute is optional
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Toc> getTocs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Toc".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
