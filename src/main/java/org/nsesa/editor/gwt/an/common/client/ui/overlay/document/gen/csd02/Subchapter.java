...
/**
 * this element is a hierarchical container called "subchapter" either explicitly or due to the local<br/> tradition
...
public class Subchapter extends HierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "subchapter");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Subchapter</code> object and set up its type
     */
    public Subchapter() {
        super(create());
        setType("subchapter");
     ...
     */
    public Subchapter(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Subchapter</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Subchapter alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Subchapter</code> instance
     */
    public Subchapter wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public Subchapter html(String s) {
        super.html(s);
        return this;
    }
}
