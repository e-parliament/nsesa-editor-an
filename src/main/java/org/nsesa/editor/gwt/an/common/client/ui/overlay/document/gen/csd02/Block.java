...
/**
 * the element block is a generic element for a container. It can be placed in a container instead of<br/> any of the other blocks. The attribute name is required and gives a name to the element.
...
public class Block extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("type", "block");
        span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
        span.setClassName("widget block");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Block</code> object and set up its type
     */
    public Block() {
        super(create());
        setType("block");
     ...
     */
    public Block(StringSimpleType nameAttr) {
        this();
    ...
    /**
     * Create a <code>Block</code> object with the given DOM element
     */
     ...
     *
     * @param nameAttr the new value
     * @return <code>Block</code> instance
     */
    public Block nameAttr(final StringSimpleType nameAttr) {
        setNameAttr(nameAttr);
        return this;
    }
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Block</code> instance
     */
    public Block langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Block</code> instance
     */
    public Block evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block wildcardContentAttr(final String wildcardContentAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Block</code> instance
     */
    public Block periodAttr(final AnyURISimpleType periodAttr) {
