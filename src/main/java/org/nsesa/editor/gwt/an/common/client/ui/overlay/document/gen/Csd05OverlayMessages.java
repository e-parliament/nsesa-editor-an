...
public interface Csd05OverlayMessages extends Messages {
    @Key("name.container")
    ...
    @Key("name.FRBRauthoritative")
    String nameFRBRauthoritative();

    @Key("description.FRBRauthoritative")
    String descriptionFRBRauthoritative();

    @Key("name.FRBRprescriptive")
    String nameFRBRprescriptive();

    @Key("description.FRBRprescriptive")
    String descriptionFRBRprescriptive();
    ...
    @Key("name.judgmentBody")
    String nameJudgmentBody();

    @Key("description.judgmentBody")
    String descriptionJudgmentBody();
    ...
    @Key("description.abbr")
    String descriptionAbbr();
    ...
    @Key("description.remedies")
    String descriptionRemedies();

    @Key("name.blockContainer")
    String nameBlockContainer();

    @Key("description.blockContainer")
    String descriptionBlockContainer();
    ...
    @Key("description.proviso")
    String descriptionProviso();
    ...
    @Key("description.subrule")
    String descriptionSubrule();
    ...
    @Key("name.speechGroup")
    String nameSpeechGroup();

    @Key("description.speechGroup")
    String descriptionSpeechGroup();
    ...
    @Key("name.renumberingInfo")
    String nameRenumberingInfo();

    @Key("description.renumberingInfo")
    String descriptionRenumberingInfo();
    ...
    @Key("name.documentRef")
    String nameDocumentRef();

    @Key("description.documentRef")
    String descriptionDocumentRef();
    ...
    @Key("description.judgment")
    String descriptionJudgment();
    ...
    @Key("description.subFlow")
    String descriptionSubFlow();
