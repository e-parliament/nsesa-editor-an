...
// CONSTRUCTORS ------------------
     ...
     */
    public DocDate(AnySimpleTypeSimpleType dateAttr) {
        this();
     ...
     */
    public DocDate dateAttr(final AnySimpleTypeSimpleType dateAttr) {
        setDateAttr(dateAttr);
        return this;
    }
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocDate</code> instance
     */
    public DocDate langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> DocDate</code> instance
     */
    public DocDate spaceAttr(final StringSimpleType spaceAttr) {
