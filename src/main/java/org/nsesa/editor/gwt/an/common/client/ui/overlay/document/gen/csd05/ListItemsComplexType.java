...
public class ListItemsComplexType extends OverlayWidgetImpl {
    ...
    private static StructureIndicator STRUCTURE_INDICATOR = new StructureIndicator.DefaultStructureIndicator(1, 1
            ,
            new StructureIndicator.DefaultSequence(1, 1, new StructureIndicator.DefaultElement(1, -1, new Li())
            )
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "listItemsComplexType");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>ListItemsComplexType</code> object with the given DOM element
     */
    ...
    /**
     * Return <code>java.util.List<Li></code> property
     *
    ...
    public java.util.List<Li> getLis() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Li".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Return <code>java.util.List<Li></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    ...
    /**
     * Add <code>java.util.List<Li></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
     ...
     * @return <code>ListItemsComplexType</code> instance
     */
    public ListItemsComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>ListItemsComplexType</code> instance
     */
    public ListItemsComplexType spaceAttr(final StringSimpleType spaceAttr) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public ListItemsComplexType html(String s) {
        super.html(s);
        return this;
    }
}
