...
public class FRBRnumber extends ValueTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "FRBRnumber");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public FRBRnumber refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> FRBRnumber</code> instance
     */
    public FRBRnumber shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRnumber</code> instance
     */
    public FRBRnumber showAsAttr(final StringSimpleType showAsAttr) {
