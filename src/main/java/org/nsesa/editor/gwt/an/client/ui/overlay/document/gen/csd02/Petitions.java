...
public class Petitions extends AlthierarchyComplexType  {
...
span.setAttribute("type", "petitions");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget petitions");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>Petitions</code> object and set up its type
*/
public Petitions() {
super(create());
setType("petitions");
...
*/
public Petitions(IDSimpleType idAttr) {
this();
setIdAttr(idAttr);
}
...
/**
* Create a <code>Petitions</code> object with the given DOM element
*/
public Petitions(Element element) {
super(element);
}
...
//Override all attributes methods to be conformant with DSL approach
        ...
        */
        public Petitions refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code> Petitions</code> instance
        */
        public Petitions periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public Petitions html(String s) {
    super.html(s);
    return this;
}
}
