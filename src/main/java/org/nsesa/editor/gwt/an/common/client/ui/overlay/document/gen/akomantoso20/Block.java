...
/**
* the element block is a generic element for a container. It can be placed in a container instead<br/> of any of the other blocks. The attribute name is required and gives a name to the element.
