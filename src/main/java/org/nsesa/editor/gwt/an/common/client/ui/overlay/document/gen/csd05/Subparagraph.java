...
public class Subparagraph extends HierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "subparagraph");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Subparagraph</code> instance
     */
    public Subparagraph langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Subparagraph</code> instance
     */
    public Subparagraph spaceAttr(final StringSimpleType spaceAttr) {
