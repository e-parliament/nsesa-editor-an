...
public class Decision extends MaincontentComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "decision");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Decision</code> instance
     */
    public Decision langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Decision</code> instance
     */
    public Decision spaceAttr(final StringSimpleType spaceAttr) {
