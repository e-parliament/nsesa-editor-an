...
/**
 * The element eventInfo is a metadata element specifying facts about an event that had an effect<br/> on the document. For each event, a date, a type and a document that generated the event must be<br/> referenced.
