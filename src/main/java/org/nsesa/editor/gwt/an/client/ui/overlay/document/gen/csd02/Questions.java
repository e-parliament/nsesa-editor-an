...
public class Questions extends AlthierarchyComplexType  {
...
span.setAttribute("type", "questions");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget questions");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>Questions</code> object and set up its type
*/
public Questions() {
super(create());
setType("questions");
...
*/
public Questions(IDSimpleType idAttr) {
this();
setIdAttr(idAttr);
}
...
/**
* Create a <code>Questions</code> object with the given DOM element
*/
public Questions(Element element) {
super(element);
}
...
//Override all attributes methods to be conformant with DSL approach
        ...
        */
        public Questions refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code> Questions</code> instance
        */
        public Questions evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code> Questions</code> instance
        */
        public Questions periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public Questions html(String s) {
    super.html(s);
    return this;
}
}
