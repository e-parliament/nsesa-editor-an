...
public class AmendmentsComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "AmendmentsComplexType");
...
// FIELDS ------------------
    ...
    public java.util.List<TextualMod> getTextualMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TextualMod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<MeaningMod> getMeaningMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("MeaningMod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ScopeMod> getScopeMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ScopeMod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ForceMod> getForceMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ForceMod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<EfficacyMod> getEfficacyMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("EfficacyMod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<LegalSystemMod> getLegalSystemMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("LegalSystemMod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
