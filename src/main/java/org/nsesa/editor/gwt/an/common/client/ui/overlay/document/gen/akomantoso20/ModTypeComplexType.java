...
/**
 * the complex type modType specifies the content that is allowed within mod, mmod and rmod<br/> elements, i.e. it adds quotedText and quotedStructure to the normal list of inline elements
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<QuotedText> getQuotedTexts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("QuotedText".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<QuotedStructure> getQuotedStructures() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("QuotedStructure".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
