...
/**
 * The element organization is an inline element to identify a text fragment introducing or<br/> referring to an organization in the ontology
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Organization extends InlinereqreqComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "organization");
        span.setAttribute("data-ns", "http://www.akomantoso.org/2.0");
        span.setClassName("widget organization");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Organization</code> object and set up its type
     */
    public Organization() {
        super(create());
    ...
    /**
     * Create a <code>Organization</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Organization</code> instance
     */
    public Organization classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Organization</code> instance
     */
    public Organization periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Organization</code> instance
     */
    public Organization styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Organization</code> instance
     */
    public Organization titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Organization</code> instance
     */
    public Organization wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public Organization html(String s) {
        super.html(s);
        return this;
    }
}
