...
public class OpenStructureComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "openStructureComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public MainBody getMainBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("MainBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
