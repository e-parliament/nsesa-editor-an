...
/**
 * this element is a structural container for parts of a debates that contain communications from the<br/> house
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Communication extends AlthierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "communication");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
        span.setClassName("widget communication");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Communication</code> object and set up its type
     */
     ...
     */
    public Communication(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Communication</code> object with the given DOM element
     */
    public Communication(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Communication alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Communication</code> instance
     */
    public Communication langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Communication</code> instance
     */
    public Communication wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public Communication html(String s) {
        super.html(s);
        return this;
    }
}
