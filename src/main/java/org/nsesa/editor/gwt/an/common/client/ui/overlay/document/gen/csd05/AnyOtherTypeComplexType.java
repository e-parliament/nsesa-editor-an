...
public class AnyOtherTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "anyOtherTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<OverlayWidgetImpl> getWildcardContents() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("OverlayWidgetImpl".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
