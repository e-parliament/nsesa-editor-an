...
public class ListConclusion extends InlineComplexType  {
...
span.setAttribute("type", "listConclusion");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget listConclusion");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>ListConclusion</code> object and set up its type
*/
public ListConclusion() {
super(create());
setType("listConclusion");
}



/**
* Create a <code>ListConclusion</code> object with the given DOM element
*/
public ListConclusion(Element element) {
super(element);
}
...
//Override all attributes methods to be conformant with DSL approach
        ...
        */
        public ListConclusion langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> ListConclusion</code> instance
        */
        public ListConclusion periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public ListConclusion html(String s) {
    super.html(s);
    return this;
}
}
