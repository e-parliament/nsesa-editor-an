 ...
 * @version $Id$
 */
public class AkomaNtoso30AmendmentDialogModifyController extends AmendmentDialogModifyController {

    private static final Logger LOG = Logger.getLogger(AkomaNtoso30AmendmentDialogModifyController.class.getName());
    ...
    @Inject
    public AkomaNtoso30AmendmentDialogModifyController(final ClientFactory clientFactory,
