...
public class CitationHierarchyComplexType extends BasehierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "citationHierarchyComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>CitationHierarchyComplexType</code> instance
     */
    public CitationHierarchyComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>CitationHierarchyComplexType</code> instance
     */
    public CitationHierarchyComplexType spaceAttr(final StringSimpleType spaceAttr) {
