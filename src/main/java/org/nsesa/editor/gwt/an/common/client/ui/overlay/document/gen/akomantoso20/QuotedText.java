...
/**
 * the element quotedText is an inline element containing a small string that is used either as<br/> the text being replaced, or the replacement, or the positioning at which some modification should<br/> take place. Use attribute for when quotedText is used in a mmod or rmod to point to the id of the<br/> corresponding ref element.
