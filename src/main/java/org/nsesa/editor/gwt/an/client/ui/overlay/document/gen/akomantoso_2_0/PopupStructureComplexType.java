...
private java.util.List<Content> content_s = new ArrayList<Content>();
...
public java.util.List<Content> getContent_() {
return content_s;
}

public void setContent_(final java.util.List<Content> content_s) {
