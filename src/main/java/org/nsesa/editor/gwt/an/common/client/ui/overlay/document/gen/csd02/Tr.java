    ...
    private AnyURISimpleType periodAttr;
            ...
            */
            public java.util.List<Th> getThs() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Th".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Td> getTds() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Td".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
        ...
        * @return <code>Tr</code> instance
        */
        public Tr spaceAttr(final NCNameSimpleType spaceAttr) {
