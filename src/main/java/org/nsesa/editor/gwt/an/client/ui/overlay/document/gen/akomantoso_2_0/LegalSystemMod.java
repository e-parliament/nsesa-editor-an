...
public ArrayList<String> getAllowedSubTypes() {
    String[] arrayChildren = new String[]{"application","modifiersAttrGroup","coreAttrGroup","condition","LegalSystemModsSimpleType","idreqAttrGroup","efficacy","destination","duration","source","enactmentAttrGroup","force","refersAttrGroup"};
