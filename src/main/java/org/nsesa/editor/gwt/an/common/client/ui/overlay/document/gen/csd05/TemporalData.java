...
public class TemporalData extends OverlayWidgetImpl {
    ...
    private static StructureIndicator STRUCTURE_INDICATOR = new StructureIndicator.DefaultStructureIndicator(1, 1
            ...
            new StructureIndicator.DefaultSequence(1, 1, new StructureIndicator.DefaultElement(1, -1, new TemporalGroup())
                    , new StructureIndicator.DefaultElement(0, -1, new RenumberingInfo())
            )
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Return <code>java.util.List<RenumberingInfo></code> property
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<RenumberingInfo> getRenumberingInfos() {
        java.util.List<RenumberingInfo> result = new ArrayList<RenumberingInfo>();
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("RenumberingInfo".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((RenumberingInfo) widget);
            }
        }
    ...
    /**
     * Return <code>java.util.List<RenumberingInfo></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<RenumberingInfo> getRenumberingInfoList() {
        return getRenumberingInfos();
    }

    /**
     * Add <code>java.util.List<RenumberingInfo></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public RenumberingInfo addRenumberingInfo(RenumberingInfo renumberingInfoElem) {
        this.addOverlayWidget(renumberingInfoElem);
        return renumberingInfoElem;
    }
    ...
    public java.util.List<TemporalGroup> getTemporalGroups() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TemporalGroup".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
