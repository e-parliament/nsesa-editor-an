...
import org.nsesa.editor.gwt.an.common.client.ui.overlay.document.gen.xmlschema.DecimalSimpleType;
...
/**
* Create an empty <code>IntegerSimpleType</code> object
*/
public IntegerSimpleType() {
super();
}
/**
* Create a <code>IntegerSimpleType</code> object with teh given input data
*/
public IntegerSimpleType(String value) {
super();
this.value = value;
}
