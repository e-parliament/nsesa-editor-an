...
,        new StructureIndicator.DefaultGroup(1,1,        new StructureIndicator.DefaultChoice(1,1,        new StructureIndicator.DefaultElement(1,1,new Recitals())
...
/**
* Create a <code>PreambleoptComplexType</code> object with the given DOM element
*/
...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @param alternativeToAttr the new value
        * @return <code>PreambleoptComplexType</code> instance
        */
        ...
        * @return <code>PreambleoptComplexType</code> instance
        */
        public PreambleoptComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
...
*/
@Override
public PreambleoptComplexType html(String s) {
    super.html(s);
    return this;
}
}
