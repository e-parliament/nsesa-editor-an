...
/**
 * this element is a hierarchical container called "book" either explicitly or due to the local<br/> tradition
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Book extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Book</code> object and set up its type
     */
    public Book() {
        super(create());
        setType("book");
     ...
     */
    public Book(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Book</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Book alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Book</code> instance
     */
    public Book langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Book</code> instance
     */
    public Book wildcardContentAttr(final String wildcardContentAttr) {
