...
/**
 * the element preamble is used as a container of the text that opens the main body of the document as<br/> a preamble
...
public class Preamble extends PreambleoptComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "preamble");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Preamble</code> object and set up its type
     */
    public Preamble() {
        super(create());
        setType("preamble");
    ...
    /**
     * Create a <code>Preamble</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Preamble</code> instance
     */
    public Preamble spaceAttr(final NCNameSimpleType spaceAttr) {
