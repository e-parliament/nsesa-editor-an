...
/**
 * this element is a structural container for parts of a debates that contain the administration of an<br/> oath
...
public class AdministrationOfOath extends AlthierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "administrationOfOath");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>AdministrationOfOath</code> object and set up its type
     */
     ...
     */
    public AdministrationOfOath(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>AdministrationOfOath</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public AdministrationOfOath alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> AdministrationOfOath</code> instance
     */
    public AdministrationOfOath wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public AdministrationOfOath html(String s) {
        super.html(s);
        return this;
    }
}
