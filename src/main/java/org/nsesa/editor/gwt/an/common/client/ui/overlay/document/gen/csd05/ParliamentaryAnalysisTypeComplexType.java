...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Quorum> getQuorums() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Quorum".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Count> getCounts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Count".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
