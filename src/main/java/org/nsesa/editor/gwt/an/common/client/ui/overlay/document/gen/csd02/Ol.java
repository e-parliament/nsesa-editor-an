...
/**
 * The element ol is an HTML element and is used in Akoma Ntoso as in HTML, for an ordered list of list<br/> item (elements li)
...
public class Ol extends ListItemsComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "ol");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Ol</code> instance
     */
    public Ol spaceAttr(final NCNameSimpleType spaceAttr) {
