...
/**
 * the element change is an inline element that identifies the changes expressed in the two<br/> columns of an amendment document
...
public class Change extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "change");
