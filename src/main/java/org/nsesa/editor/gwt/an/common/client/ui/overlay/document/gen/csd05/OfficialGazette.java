...
public class OfficialGazette extends CollectionStructureComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "officialGazette");
...
// CONSTRUCTORS ------------------
     ...
     */
    public OfficialGazette(StringSimpleType nameAttr) {
        this();
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> OfficialGazette</code> instance
     */
    public OfficialGazette nameAttr(final StringSimpleType nameAttr) {
        setNameAttr(nameAttr);
        return this;
    }
