...
import static org.nsesa.editor.gwt.an.common.client.ui.overlay.document.AkomaNtoso30XMLUtil.*;
 ...
 * @version $Id$
 */
public class AkomaNtoso30AmendmentBuilder {
    ...
    @Inject
    public AkomaNtoso30AmendmentBuilder(OverlayFactory overlayFactory) {
        this.overlayFactory = overlayFactory;
    }

    public AkomaNtoso30AmendmentBuilder setLanguageIso(String languageIso) {
        this.languageIso = languageIso;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setJustification(String justification) {
        this.justification = justification;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setLocation(String location) {
        this.location = location;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setNotes(String notes) {
        this.notes = notes;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setAuthors(Set<PersonDTO> authors) {
        this.authors = authors;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setOriginalText(String originalText) {
        this.originalText = originalText;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setAmendmentText(String amendmentText) {
        this.amendmentText = amendmentText;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setOverlayWidget(OverlayWidget overlayWidget) {
        this.overlayWidget = overlayWidget;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setModifyIds(boolean modifyIds) {
        this.modifyIds = modifyIds;
        return this;
    }

    public AkomaNtoso30AmendmentBuilder setDocumentController(DocumentController documentController) {
    ...
    public OverlayWidget build() {
        ...
        if (documentController != null) {
            ...
            if (isRemote) {
                references.addActiveRef(new ActiveRef(id(documentId.substring(documentId.lastIndexOf("/") + 1)), u(documentId), s(documentController.getDocument().getName())));
            } else {
                references.addActiveRef(new ActiveRef(id(documentId), u("http://at4am.org/xml/"), s(documentController.getDocument().getName())));
            }
        }
