...
/**
* the element vote is an inline that wraps either the name of the voter (when organized by<br/> choice) or the vote (when organized by name) in a voting report.
