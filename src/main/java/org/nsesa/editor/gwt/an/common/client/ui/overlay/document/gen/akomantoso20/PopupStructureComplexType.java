...
public class PopupStructureComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "popupStructureComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Intro> getIntros() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Intro".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Wrap> getWraps() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Wrap".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Content> getContent_s() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Content".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Recital> getRecitals() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Recital".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Citation> getCitations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Citation".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
