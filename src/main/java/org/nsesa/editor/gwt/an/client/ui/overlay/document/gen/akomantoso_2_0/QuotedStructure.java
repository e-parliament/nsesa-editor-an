...
public ArrayList<String> getAllowedSubTypes() {
    String[] arrayChildren = new String[]{"componentRef","citation","wrap","containerElementsGroup","ANcontainersGroup","subheading","hierElementsGroup","anyURISimpleType","intro","blockElementsGroup","content","recital","num","corereqAttrGroup","heading"};
