...
/**
 * The element derogates is a metadata element specifying a reference to a source derogated by the<br/> argument being described.
...
public class Derogates extends JudicialArgumentTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "derogates");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Derogates</code> object and set up its type
     */
    public Derogates() {
        super(create());
        setType("derogates");
    ...
    /**
     * Create a <code>Derogates</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Derogates</code> instance
     */
     ...
     */
    @Override
    public Derogates html(String s) {
        super.html(s);
        return this;
    }
}
