...
/**
 * the element placeholder is an inline element containing the text of a computable expression<br/> (e.g., ''30 days after the publication of this act'') that can be replaced editorially with an actual<br/> value
