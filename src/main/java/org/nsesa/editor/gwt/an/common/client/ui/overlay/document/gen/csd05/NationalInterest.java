...
public class NationalInterest extends AlthierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "nationalInterest");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> NationalInterest</code> instance
     */
    public NationalInterest langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> NationalInterest</code> instance
     */
    public NationalInterest spaceAttr(final StringSimpleType spaceAttr) {
