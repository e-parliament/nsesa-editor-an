...
public class DebateBody extends DebateBodyTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "debateBody");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DebateBody</code> instance
     */
    public DebateBody langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> DebateBody</code> instance
     */
    public DebateBody spaceAttr(final StringSimpleType spaceAttr) {
