...
/**
 * the type collectionBodyType specifies a content model of a container of a list of other documents<br/> (e.g, acts, bills, amendments, etc.) possibly interspersed with interstitial elements with content<br/> that does not form an individual document
...
public class CollectionBodyTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "collectionBodyTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Interstitial> getInterstitials() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Interstitial".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
     ...
     * @return <code>CollectionBodyTypeComplexType</code> instance
     */
    public CollectionBodyTypeComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
