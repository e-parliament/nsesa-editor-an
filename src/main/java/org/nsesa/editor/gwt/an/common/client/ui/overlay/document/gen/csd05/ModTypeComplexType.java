...
public class ModTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "modTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<QuotedText> getQuotedTexts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("QuotedText".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<QuotedStructure> getQuotedStructures() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("QuotedStructure".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
     ...
     * @return <code>ModTypeComplexType</code> instance
     */
    public ModTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>ModTypeComplexType</code> instance
     */
    public ModTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
