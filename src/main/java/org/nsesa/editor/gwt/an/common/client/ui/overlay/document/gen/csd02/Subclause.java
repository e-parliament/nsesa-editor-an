...
/**
 * this element is a hierarchical container called "subclause" either explicitly or due to the local<br/> tradition
...
public class Subclause extends HierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "subclause");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Subclause</code> object and set up its type
     */
    public Subclause() {
        super(create());
        setType("subclause");
     ...
     */
    public Subclause(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Subclause</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Subclause</code> instance
     */
    public Subclause spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     */
    @Override
    public Subclause html(String s) {
        super.html(s);
        return this;
    }
}
