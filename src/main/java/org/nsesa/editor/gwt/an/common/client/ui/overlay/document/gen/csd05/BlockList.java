...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Item> getItems() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Item".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
     ...
     * @return <code>BlockList</code> instance
     */
    public BlockList langAttr(final StringSimpleType langAttr) {
    ...
    public ListConclusion getListConclusion() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ListConclusion".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public ListIntroduction getListIntroduction() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ListIntroduction".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
     ...
     * @return <code>BlockList</code> instance
     */
    public BlockList spaceAttr(final StringSimpleType spaceAttr) {
