...
public class AmendmentHeading extends BlocksoptComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "amendmentHeading");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> AmendmentHeading</code> instance
     */
    public AmendmentHeading langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> AmendmentHeading</code> instance
     */
    public AmendmentHeading spaceAttr(final StringSimpleType spaceAttr) {
