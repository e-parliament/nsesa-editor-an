...
public class Recitals extends RecitalHierarchyComplexType {
...
// CONSTRUCTORS ------------------
     ...
     */
    public Recitals(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Recitals</code> instance
     */
    public Recitals langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Recitals</code> instance
     */
    public Recitals spaceAttr(final StringSimpleType spaceAttr) {
