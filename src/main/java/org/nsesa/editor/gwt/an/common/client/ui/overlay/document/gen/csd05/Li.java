...
/**
 * TYPE<br/>Element<br/>NAME<br/>li<br/>The element li is an HTML element and is used in Akoma Ntoso as in HTML, for the generic list item (not a pattern)
...
public class Li extends OverlayWidgetImpl {
    ...
    private static StructureIndicator STRUCTURE_INDICATOR = new StructureIndicator.DefaultStructureIndicator(1, 1
            ...
            new StructureIndicator.DefaultChoice(0, -1, new StructureIndicator.DefaultGroup(1, 1, new StructureIndicator.DefaultChoice(1, 1, new StructureIndicator.DefaultGroup(1, 1, new StructureIndicator.DefaultChoice(1, 1, new StructureIndicator.DefaultGroup(1, 1, new StructureIndicator.DefaultChoice(1, 1, new StructureIndicator.DefaultElement(1, 1, new Ref())
                    ...
                    , new StructureIndicator.DefaultElement(1, 1, new Ul())
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Li</code> object and set up its type
     */
    public Li() {
        super(create());
        setType("li");
    ...
    /**
     * Create a <code>Li</code> object with the given DOM element
     */
     ...
     * @return <code>Li</code> instance
     */
    public Li langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>Li</code> instance
     */
    public Li spaceAttr(final StringSimpleType spaceAttr) {
