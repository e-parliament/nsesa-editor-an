...
/**
 * this element is a hierarchical container called "part" either explicitly or due to the local<br/> tradition
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Part extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Part</code> object and set up its type
     */
    public Part() {
        super(create());
        setType("part");
     ...
     */
    public Part(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Part</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Part alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Part</code> instance
     */
    public Part langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Part</code> instance
     */
    public Part wildcardContentAttr(final String wildcardContentAttr) {
