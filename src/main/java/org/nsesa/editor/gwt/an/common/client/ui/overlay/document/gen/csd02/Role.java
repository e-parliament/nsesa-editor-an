...
/**
 * The element role is an inline element to identify a text fragment introducing or referring to a role<br/> in the ontology
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Role extends InlinereqreqComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("type", "role");
        span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
        span.setClassName("widget role");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Role</code> object and set up its type
     */
    public Role() {
        super(create());
        setType("role");
    ...
    /**
     * Create a <code>Role</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Role alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Role</code> instance
     */
    public Role statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Role</code> instance
     */
    public Role classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Role</code> instance
     */
    public Role styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Role</code> instance
     */
    public Role spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Role</code> instance
     */
    public Role refersToAttr(final AnyURISimpleType refersToAttr) {
        setRefersToAttr(refersToAttr);
        return this;
    }
     ...
     * @return <code> Role</code> instance
     */
    public Role periodAttr(final AnyURISimpleType periodAttr) {
