...
/**
 * the element interstitial is used as a container of text elements and blocks that are placed for any<br/> reason between individual documents in a collection of documents
...
public class Interstitial extends BlocksreqComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "interstitial");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Interstitial</code> instance
     */
    public Interstitial spaceAttr(final NCNameSimpleType spaceAttr) {
