...
public class ModificationTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "modificationTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Source> getSources() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Source".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Destination> getDestinations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Destination".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Force getForce() {
        Force result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Force".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result = (Force) widget;
                break;
            }
        }
    ...
    public Efficacy getEfficacy() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Efficacy".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Application getApplication() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Application".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Duration getDuration() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Duration".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Condition getCondition() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Condition".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
