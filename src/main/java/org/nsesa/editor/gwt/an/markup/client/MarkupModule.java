...
import org.nsesa.editor.gwt.an.markup.client.ui.ckeditor.MarkupRichTextEditorProvider;
 ...
 * @version $Id$
 */
public class MarkupModule extends AbstractGinModule {
    @Override
    protected void configure() {
        ...
        bind(DocumentController.class).to(MarkupDocumentController.class).in(Singleton.class);
        bind(RichTextEditor.class).annotatedWith(Names.named("inlineRichTextEditor")).
                toProvider(MarkupRichTextEditorProvider.class).in(Singleton.class);
    }
}
