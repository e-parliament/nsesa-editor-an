 ...
 * @version $Id$
 */
public class DraftingSourceFileViewImpl extends Composite implements SourceFileView {
    interface MyUiBinder extends UiBinder<Widget, DraftingSourceFileViewImpl> {
    }
