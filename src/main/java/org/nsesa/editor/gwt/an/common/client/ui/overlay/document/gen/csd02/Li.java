...
/**
* TYPE Element NAME li The element li is an HTML element and is used in Akoma Ntoso as in HTML, for the generic list item (not a pattern)
...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @return <code>Li</code> instance
        */
        public Li spaceAttr(final NCNameSimpleType spaceAttr) {
