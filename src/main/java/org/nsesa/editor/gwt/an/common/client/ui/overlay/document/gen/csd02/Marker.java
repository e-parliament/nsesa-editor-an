...
/**
 * the element marker is a generic element for a marker. It can be placed in a block instead of any of<br/> the other markers. The attribute name is required and gives a name to the element.
...
public class Marker extends MarkerreqComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "marker");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Marker</code> instance
     */
    public Marker spaceAttr(final NCNameSimpleType spaceAttr) {
