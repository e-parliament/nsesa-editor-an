...
/**
 * the element session is an inline element within preface to identify the string used by the<br/> document for the session of the legislature relative to the document. Use #refersTo to a TLCEvent to<br/> refer to the event of the specific session.
