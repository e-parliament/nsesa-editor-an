...
/**
 * the element docJurisdiction is an inline element within preface to identify the string used by the<br/> document detailing the jurisdiction of the document
...
public class DocJurisdiction extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "docJurisdiction");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>DocJurisdiction</code> object and set up its type
     */
    ...
    /**
     * Create a <code>DocJurisdiction</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocJurisdiction</code> instance
     */
     ...
     * @return <code> DocJurisdiction</code> instance
     */
    public DocJurisdiction spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     */
    @Override
    public DocJurisdiction html(String s) {
        super.html(s);
        return this;
    }
}
