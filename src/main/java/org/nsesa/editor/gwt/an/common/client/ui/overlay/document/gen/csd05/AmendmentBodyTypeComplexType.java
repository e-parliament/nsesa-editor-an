...
public class AmendmentBodyTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "amendmentBodyTypeComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>AmendmentBodyTypeComplexType</code> instance
     */
    public AmendmentBodyTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>AmendmentBodyTypeComplexType</code> instance
     */
    public AmendmentBodyTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
    ...
    public java.util.List<AmendmentHeading> getAmendmentHeadings() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AmendmentHeading".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<AmendmentContent> getAmendmentContents() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AmendmentContent".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<AmendmentReference> getAmendmentReferences() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AmendmentReference".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<AmendmentJustification> getAmendmentJustifications() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AmendmentJustification".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
