...
public class FragmentBodyTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "fragmentBodyTypeComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>FragmentBodyTypeComplexType</code> instance
     */
    public FragmentBodyTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>FragmentBodyTypeComplexType</code> instance
     */
    public FragmentBodyTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
    ...
    /**
     * Add <code>Rule</code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Rule getRule() {
    ...
    /**
     * Set <code>ruleElem</code> property in DSL way
     *
     * @param ruleElem new value
     * @return <code>Rule</code> instance
     */
    public Rule setRule(Rule ruleElem) {
        Rule result = getRule();
        // remove the child of the same type if exist
        if (result != null) {
            this.removeOverlayWidget(result);
    ...
    /**
     * Add <code>Subrule</code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    ...
    /**
     * Set <code>subruleElem</code> property in DSL way
     *
     * @param subruleElem new value
     * @return <code>Subrule</code> instance
     */
    public Subrule setSubrule(Subrule subruleElem) {
        Subrule result = getSubrule();
        // remove the child of the same type if exist
        if (result != null) {
            this.removeOverlayWidget(result);
        }
    ...
    /**
     * Add <code>Proviso</code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Proviso getProviso() {
        Proviso result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
    ...
    /**
     * Set <code>provisoElem</code> property in DSL way
     *
     * @param provisoElem new value
     * @return <code>Proviso</code> instance
     */
    public Proviso setProviso(Proviso provisoElem) {
        Proviso result = getProviso();
        // remove the child of the same type if exist
        if (result != null) {
            this.removeOverlayWidget(result);
        }
    ...
    /**
     * Add <code>Subdivision</code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    ...
    /**
     * Set <code>subdivisionElem</code> property in DSL way
     *
     * @param subdivisionElem new value
     * @return <code>Subdivision</code> instance
     */
    public Subdivision setSubdivision(Subdivision subdivisionElem) {
    ...
    /**
     * Add <code>Transitional</code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Transitional getTransitional() {
        Transitional result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
    ...
    /**
     * Set <code>transitionalElem</code> property in DSL way
     *
     * @param transitionalElem new value
     * @return <code>Transitional</code> instance
     */
    public Transitional setTransitional(Transitional transitionalElem) {
        Transitional result = getTransitional();
        // remove the child of the same type if exist
        if (result != null) {
            this.removeOverlayWidget(result);
        }
