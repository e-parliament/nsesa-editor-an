...
/**
 * the element eol (end of line) is a marker for where in the original text the line breaks. If the<br/> line breaks within a word, place the element BEFORE the word and place the number of characters<br/> before the break in the attribute breakat
