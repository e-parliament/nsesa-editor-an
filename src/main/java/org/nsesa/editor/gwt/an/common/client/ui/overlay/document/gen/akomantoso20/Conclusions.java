...
import org.nsesa.editor.gwt.an.common.client.ui.overlay.document.gen.akomantoso20.BasicoptComplexType;
...
/**
* the element conclusion is used as a container of all concluding material (e.g. dates,<br/> signatures, formulas, etc.)
...
// CONSTRUCTORS ------------------
/**
* Create a <code>Conclusions</code> object and set up its type
*/
public Conclusions() {
super(create());
setType("conclusions");
...
/**
* Create a <code>Conclusions</code> object with the given DOM element
*/
...
*/
@Override
public Conclusions html(String s) {
    super.html(s);
    return this;
}
}
