...
public class BodyTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "bodyTypeComplexType");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>BodyTypeComplexType</code> object with the given DOM element
     */
     ...
     * @return <code>BodyTypeComplexType</code> instance
     */
    public BodyTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>BodyTypeComplexType</code> instance
     */
    public BodyTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public BodyTypeComplexType html(String s) {
        super.html(s);
        return this;
    }
}
