...
/**
 * the element courtType is an inline element within judgements to identify the string used by the<br/> document for the type of the court doing the judgement
...
public class CourtType extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "courtType");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> CourtType</code> instance
     */
    public CourtType spaceAttr(final NCNameSimpleType spaceAttr) {
