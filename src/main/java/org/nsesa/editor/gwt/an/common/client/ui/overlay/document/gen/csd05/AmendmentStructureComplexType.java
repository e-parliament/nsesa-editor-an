...
public class AmendmentStructureComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "amendmentStructureComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>AmendmentStructureComplexType</code> instance
     */
    public AmendmentStructureComplexType nameAttr(final StringSimpleType nameAttr) {
    ...
    public AmendmentBody getAmendmentBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AmendmentBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
