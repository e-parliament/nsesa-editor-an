...
public class InlineComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "inlineComplexType");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05");
        span.setClassName("widget inlineComplexType");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>InlineComplexType</code> object with the given DOM element
     */
     ...
     *
     * @param alternativeToAttr the new value
     * @return <code>InlineComplexType</code> instance
     */
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code>InlineComplexType</code> instance
     */
    public InlineComplexType periodAttr(final AnyURISimpleType periodAttr) {
    ...
    public java.util.List<Inline> getInlines() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Inline".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Marker> getMarkers() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Marker".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Return <code>java.util.List<SubFlow></code> property
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<SubFlow> getSubFlows() {
        java.util.List<SubFlow> result = new ArrayList<SubFlow>();
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("SubFlow".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((SubFlow) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    }
    ...
    /**
     * Return <code>java.util.List<SubFlow></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<SubFlow> getSubFlowList() {
        return getSubFlows();
    }

    /**
     * Add <code>java.util.List<SubFlow></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public SubFlow addSubFlow(SubFlow subFlowElem) {
        this.addOverlayWidget(subFlowElem);
        return subFlowElem;
    }
    ...
    public java.util.List<Ref> getRefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Ref".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Mref> getMrefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Mref".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Rref> getRrefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Rref".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Mod> getMods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Mod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Mmod> getMmods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Mmod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Rmod> getRmods() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Rmod".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Remark> getRemarks() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Remark".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<RecordedTime> getRecordedTimes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("RecordedTime".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Vote> getVotes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Vote".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Outcome> getOutcomes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Outcome".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Ins> getInses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Ins".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Del> getDels() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Del".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Omissis> getOmissises() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Omissis".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ExtractText> getExtractTexts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ExtractText".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ExtractStructure> getExtractStructures() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ExtractStructure".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Placeholder> getPlaceholders() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Placeholder".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<FillIn> getFillIns() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FillIn".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Return <code>java.util.List<Decoration></code> property
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Decoration> getDecorations() {
        java.util.List<Decoration> result = new ArrayList<Decoration>();
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Decoration".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Return <code>java.util.List<Decoration></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Decoration> getDecorationList() {
        return getDecorations();
    }

    /**
     * Add <code>java.util.List<Decoration></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Decoration addDecoration(Decoration decorationElem) {
        this.addOverlayWidget(decorationElem);
    ...
    public java.util.List<B> getBs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("B".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((B) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    ...
    public java.util.List<I> getIs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("I".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((I) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    ...
    public java.util.List<A> getAs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("A".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((A) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    ...
    public java.util.List<U> getUs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("U".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((U) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    ...
    public java.util.List<Sub> getSubs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Sub".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Sup> getSups() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Sup".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Abbr> getAbbrs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Abbr".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Span> getSpans() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Span".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocType> getDocTypes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocType".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocTitle> getDocTitles() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocTitle".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocNumber> getDocNumbers() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocNumber".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocProponent> getDocProponents() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocProponent".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocDate> getDocDates() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocDate".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Legislature> getLegislatures() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Legislature".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Session> getSessions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Session".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ShortTitle> getShortTitles() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ShortTitle".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocPurpose> getDocPurposes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocPurpose".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocCommittee> getDocCommittees() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocCommittee".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocIntroducer> getDocIntroducers() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocIntroducer".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocStage> getDocStages() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocStage".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocStatus> getDocStatuses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocStatus".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocJurisdiction> getDocJurisdictions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocJurisdiction".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<DocketNumber> getDocketNumbers() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DocketNumber".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Date> getDates() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Date".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Time> getTimes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Time".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Person> getPersons() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Person".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Organization> getOrganizations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Organization".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Concept> getConcepts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Concept".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Object> getObjects() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Object".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Event> getEvents() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Event".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Location> getLocations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Location".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Process> getProcesses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Process".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Role> getRoles() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Role".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Term> getTerms() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Term".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Quantity> getQuantities() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Quantity".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Def> getDefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Def".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Entity> getEntities() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Entity".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<CourtType> getCourtTypes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("CourtType".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<NeutralCitation> getNeutralCitations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("NeutralCitation".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Party> getParties() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Party".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Judge> getJudges() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Judge".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Lawyer> getLawyers() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Lawyer".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Signature> getSignatures() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Signature".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Opinion> getOpinions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Opinion".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    /**
     * Return <code>java.util.List<Argument></code> property
     *
     * @return The property as unmodifiable list
     */
    public java.util.List<Argument> getArguments() {
        java.util.List<Argument> result = new ArrayList<Argument>();
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Argument".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result.add((Argument) widget);
            }
        }
        return java.util.Collections.unmodifiableList(result);
    }
    ...
    /**
     * Return <code>java.util.List<Argument></code> property in DSL way
     *
     * @return The property as unmodifiable list
     */
    ...
    /**
     * Add <code>java.util.List<Argument></code> property in the list of properties
     *
     * @return The property as unmodifiable list
     */
    public Argument addArgument(Argument argumentElem) {
        this.addOverlayWidget(argumentElem);
        return argumentElem;
    }
    ...
    public java.util.List<AffectedDocument> getAffectedDocuments() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AffectedDocument".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<RelatedDocument> getRelatedDocuments() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("RelatedDocument".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Change> getChanges() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Change".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<NoteRef> getNoteRefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("NoteRef".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Eol> getEols() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Eol".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Eop> getEops() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Eop".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Img> getImgs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Img".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Br> getBrs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Br".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<AuthorialNote> getAuthorialNotes() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AuthorialNote".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public InlineComplexType html(String s) {
        super.html(s);
        return this;
    }
}
