...
public ArrayList<String> getAllowedSubTypes() {
    String[] arrayChildren = new String[]{"application","modifiersAttrGroup","coreAttrGroup","condition","MeaningModsSimpleType","idreqAttrGroup","efficacy","destination","duration","source","domain","enactmentAttrGroup","force","refersAttrGroup"};
