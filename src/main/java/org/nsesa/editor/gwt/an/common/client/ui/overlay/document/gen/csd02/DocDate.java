...
/**
 * the element docDate is an inline element within preface to identify the string used by the document<br/> for its own date(s). Documents with multiple dates may use multiple docDate elements.
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>DocDate</code> instance
     */
    public DocDate timeAttr(final TimeSimpleType timeAttr) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocDate</code> instance
     */
    public DocDate spaceAttr(final NCNameSimpleType spaceAttr) {
