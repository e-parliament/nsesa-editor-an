...
/**
 * the element foreign is a generic container for elements not belonging to the Akoma Ntoso (e.g.,<br/> mathematical formulas). It is an inline element and thus can be placed in a block.
...
public class Foreign extends AnyOtherTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "foreign");
