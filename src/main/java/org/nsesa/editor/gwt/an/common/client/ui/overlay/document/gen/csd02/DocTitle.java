...
/**
 * the element docTitle is an inline element within preface to identify the string used by the document<br/> for its own title
...
public class DocTitle extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "docTitle");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>DocTitle</code> object and set up its type
     */
    public DocTitle() {
        super(create());
        setType("docTitle");
    ...
    /**
     * Create a <code>DocTitle</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocTitle</code> instance
     */
     ...
     * @return <code> DocTitle</code> instance
     */
    public DocTitle spaceAttr(final NCNameSimpleType spaceAttr) {
