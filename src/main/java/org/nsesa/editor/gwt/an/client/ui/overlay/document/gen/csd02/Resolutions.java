...
public class Resolutions extends AlthierarchyComplexType  {
...
span.setAttribute("type", "resolutions");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget resolutions");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>Resolutions</code> object and set up its type
*/
public Resolutions() {
super(create());
setType("resolutions");
...
*/
public Resolutions(IDSimpleType idAttr) {
this();
setIdAttr(idAttr);
}
...
/**
* Create a <code>Resolutions</code> object with the given DOM element
*/
public Resolutions(Element element) {
super(element);
}
...
//Override all attributes methods to be conformant with DSL approach
        ...
        */
        public Resolutions refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code> Resolutions</code> instance
        */
        public Resolutions periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public Resolutions html(String s) {
    super.html(s);
    return this;
}
}
