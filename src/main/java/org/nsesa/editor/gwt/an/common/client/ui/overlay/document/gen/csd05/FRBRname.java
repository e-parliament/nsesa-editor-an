...
/**
 * The element FRBRname is the metadata property containing a string for the title to be used in the work-level URI of this document
...
public class FRBRname extends ValueTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "FRBRname");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public FRBRname refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> FRBRname</code> instance
     */
    public FRBRname shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRname</code> instance
     */
    public FRBRname showAsAttr(final StringSimpleType showAsAttr) {
