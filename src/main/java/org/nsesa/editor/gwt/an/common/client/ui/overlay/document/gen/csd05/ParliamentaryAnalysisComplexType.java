...
// FIELDS ------------------
    ...
    public java.util.List<QuorumVerification> getQuorumVerifications() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("QuorumVerification".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Voting> getVotings() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Voting".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Recount> getRecounts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Recount".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
