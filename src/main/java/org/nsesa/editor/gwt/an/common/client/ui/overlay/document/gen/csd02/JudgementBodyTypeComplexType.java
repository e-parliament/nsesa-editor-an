...
public class JudgementBodyTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "judgementBodyTypeComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>JudgementBodyTypeComplexType</code> instance
     */
    public JudgementBodyTypeComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
    ...
    public java.util.List<Introduction> getIntroductions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Introduction".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Background> getBackgrounds() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Background".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Arguments> getArgumentses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Arguments".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Remedies> getRemedieses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Remedies".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Motivation> getMotivations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Motivation".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Decision> getDecisions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Decision".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
