...
/**
* the element ref is an inline element containing a legal references (i.e. a reference to a<br/> document with legal status and for which an Akoma Ntoso URI exists)
