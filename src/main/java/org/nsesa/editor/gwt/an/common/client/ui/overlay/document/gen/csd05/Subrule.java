...
public class Subrule extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Subrule</code> object and set up its type
     */
    public Subrule() {
        super(create());
        setType("subrule");
     ...
     */
    public Subrule(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Subrule</code> object with the given DOM element
     */
    public Subrule(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Subrule alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Subrule</code> instance
     */
    public Subrule wildcardContentAttr(final String wildcardContentAttr) {
