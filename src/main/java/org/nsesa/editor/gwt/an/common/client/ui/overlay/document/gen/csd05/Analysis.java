...
// CONSTRUCTORS ------------------
    ...
    public ActiveModifications getActiveModifications() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ActiveModifications".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Judicial getJudicial() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Judicial".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<OtherAnalysis> getOtherAnalysises() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("OtherAnalysis".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Parliamentary getParliamentary() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Parliamentary".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public PassiveModifications getPassiveModifications() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("PassiveModifications".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
