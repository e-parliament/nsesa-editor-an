...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public FRBRformat refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> FRBRformat</code> instance
     */
    public FRBRformat shortFormAttr(final StringSimpleType shortFormAttr) {
     ...
     * @return <code> FRBRformat</code> instance
     */
    public FRBRformat showAsAttr(final StringSimpleType showAsAttr) {
