...
// FIELDS ------------------
            ...
            */
            public Result getResult() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Result".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Supports> getSupportses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Supports".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<IsAnalogTo> getIsAnalogTos() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("IsAnalogTo".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Applies> getApplieses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Applies".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Extends> getExtend_s() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Extends".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Restricts> getRestrictses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Restricts".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Derogates> getDerogateses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Derogates".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Contrasts> getContrastses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Contrasts".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Overrules> getOverruleses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Overrules".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<DissentsFrom> getDissentsFroms() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("DissentsFrom".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<PutsInQuestion> getPutsInQuestions() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("PutsInQuestion".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
            ...
            */
            public java.util.List<Distinguishes> getDistinguisheses() {
                ...
                for (OverlayWidget widget : getChildOverlayWidgets()) {
                    if ("Distinguishes".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
