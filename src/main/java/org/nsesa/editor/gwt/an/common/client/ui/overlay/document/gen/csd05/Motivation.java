...
public class Motivation extends MaincontentComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "motivation");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Motivation</code> instance
     */
    public Motivation langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Motivation</code> instance
     */
    public Motivation spaceAttr(final StringSimpleType spaceAttr) {
