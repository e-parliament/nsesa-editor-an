...
public class Container extends ContainerTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "container");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Container</code> instance
     */
    public Container langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Container</code> instance
     */
    public Container spaceAttr(final StringSimpleType spaceAttr) {
