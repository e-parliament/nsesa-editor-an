...
public class CoverPage extends BasicoptComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "coverPage");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> CoverPage</code> instance
     */
    public CoverPage langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> CoverPage</code> instance
     */
    public CoverPage spaceAttr(final StringSimpleType spaceAttr) {
