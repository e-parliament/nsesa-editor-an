...
public class ExtractText extends InlineComplexType  {
...
// CONSTRUCTORS ------------------
/**
* Create a <code>ExtractText</code> object and set up its type
*/
public ExtractText() {
super(create());
setType("extractText");
...
/**
* Create a <code>ExtractText</code> object with the given DOM element
*/
public ExtractText(Element element) {
super(element);
}
...
// FIELDS ------------------
    ...
    private StringSimpleType endQuoteAttr;
        ...
        * @return <code>ExtractText</code> instance
        */
        public ExtractText endQuoteAttr(final StringSimpleType endQuoteAttr) {
...
//Override all attributes methods to be conformant with DSL approach
        ...
        * @return <code> ExtractText</code> instance
        */
        public ExtractText langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> ExtractText</code> instance
        */
        public ExtractText refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> ExtractText</code> instance
        */
        public ExtractText styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> ExtractText</code> instance
        */
        public ExtractText titleAttr(final StringSimpleType titleAttr) {
...
*/
@Override
public ExtractText html(String s) {
    super.html(s);
    return this;
}
}
