...
/**
 * this element is a hierarchical container called "paragraph" either explicitly or due to the local<br/> tradition
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Paragraph</code> object and set up its type
     */
    public Paragraph() {
        super(create());
        setType("paragraph");
     ...
     */
    public Paragraph(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Paragraph</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Paragraph alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Paragraph</code> instance
     */
    public Paragraph wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public Paragraph html(String s) {
        super.html(s);
        return this;
    }
}
