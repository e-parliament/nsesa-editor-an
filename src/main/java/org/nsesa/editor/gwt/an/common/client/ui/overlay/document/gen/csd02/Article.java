...
/**
 * this element is a hierarchical container called "article" either explicitly or due to the local<br/> tradition
...
public class Article extends HierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "article");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Article</code> object and set up its type
     */
    public Article() {
        super(create());
        setType("article");
     ...
     */
    public Article(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Article</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Article</code> instance
     */
    public Article spaceAttr(final NCNameSimpleType spaceAttr) {
