...
/**
 * the complex type preambleopt defines the content model and attributes used by preambles. Here<br/> the id attribute is optional
...
public class PreambleoptComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "preambleoptComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Recitals> getRecitalses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Recitals".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Citations> getCitationses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Citations".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Formula> getFormulas() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Formula".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
