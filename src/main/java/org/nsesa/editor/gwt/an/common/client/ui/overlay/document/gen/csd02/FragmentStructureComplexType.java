...
/**
 * the type fragmentStructure specifies the overall content model of the document type that is a<br/> fragment of another document
...
// CONSTRUCTORS ------------------
    ...
    public FragmentBody getFragmentBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FragmentBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
