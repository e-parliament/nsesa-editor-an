...
import org.nsesa.editor.gwt.an.client.ui.overlay.document.gen.csd02.BasehierarchyComplexType;
...
public class RecitalHierarchyComplexType extends BasehierarchyComplexType  {
...
span.setAttribute("type", "recitalHierarchyComplexType");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget recitalHierarchyComplexType");
return span;
}
...
/**
* Create a <code>RecitalHierarchyComplexType</code> object with the given DOM element
*/
public RecitalHierarchyComplexType(Element element) {
super(element);
}
...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @param refersToAttr the new value
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code>RecitalHierarchyComplexType</code> instance
        */
        public RecitalHierarchyComplexType periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public RecitalHierarchyComplexType html(String s) {
    super.html(s);
    return this;
}
}
