...
public class HierarchicalStructureComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "hierarchicalStructureComplexType");
...
// CONSTRUCTORS ------------------
     ...
     * @return <code>HierarchicalStructureComplexType</code> instance
     */
    public HierarchicalStructureComplexType nameAttr(final StringSimpleType nameAttr) {
    ...
    public Preface getPreface() {
        Preface result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Preface".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Preamble getPreamble() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Preamble".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Body getBody() {
        Body result = null;
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Body".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result = (Body) widget;
                break;
            }
        }
