...
/**
 * this element is a structural container for parts of a debates that are relevant to the display of<br/> papers
...
public class Papers extends AlthierarchyComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "papers");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Papers</code> object and set up its type
     */
    public Papers() {
        super(create());
        setType("papers");
     ...
     */
    public Papers(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Papers</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Papers</code> instance
     */
    public Papers spaceAttr(final NCNameSimpleType spaceAttr) {
