...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<New> getNews() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("New".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Old> getOlds() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Old".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
