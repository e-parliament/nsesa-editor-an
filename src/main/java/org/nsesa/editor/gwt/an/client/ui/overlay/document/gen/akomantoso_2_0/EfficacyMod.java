...
public ArrayList<String> getAllowedSubTypes() {
    String[] arrayChildren = new String[]{"application","modifiersAttrGroup","coreAttrGroup","condition","EfficacyModsSimpleType","idreqAttrGroup","efficacy","destination","duration","source","enactmentAttrGroup","force","refersAttrGroup"};
