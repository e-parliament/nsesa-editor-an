...
public class ContainerTypeComplexType extends OverlayWidgetImpl  {
...
/**
* Create a <code>ContainerTypeComplexType</code> object with the given DOM element
*/
...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @param nameAttr the new value
        * @return <code>ContainerTypeComplexType</code> instance
        */
        ...
        * @return <code>ContainerTypeComplexType</code> instance
        */
        public ContainerTypeComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
...
*/
@Override
public ContainerTypeComplexType html(String s) {
    super.html(s);
    return this;
}
}
