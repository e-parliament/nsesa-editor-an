...
/**
 * the complex type containerType is the content model for the generic element for a container. It can<br/> be placed in a container instead of any of the other containers. The attribute name is required and<br/> gives a name to the element.
...
public class ContainerTypeComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "containerTypeComplexType");
