...
import org.nsesa.editor.gwt.an.client.ui.overlay.document.gen.csd02.LinkTypeComplexType;
...
public class DocumentRef extends LinkTypeComplexType  {
...
// CONSTRUCTORS ------------------
/**
* Create a <code>DocumentRef</code> object and set up its type
*/
public DocumentRef() {
super(create());
setType("documentRef");
...
*/
public DocumentRef(IDSimpleType idAttr,AnyURISimpleType hrefAttr,StringSimpleType showAsAttr) {
this();
setIdAttr(idAttr);
...
/**
* Create a <code>DocumentRef</code> object with the given DOM element
*/
public DocumentRef(Element element) {
super(element);
}
...
//Override all attributes methods to be conformant with DSL approach
        ...
        */
        public DocumentRef idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
...
*/
@Override
public DocumentRef html(String s) {
    super.html(s);
    return this;
}
}
