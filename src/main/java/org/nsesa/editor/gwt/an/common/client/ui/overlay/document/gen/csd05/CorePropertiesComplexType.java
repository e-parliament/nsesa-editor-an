...
public class CorePropertiesComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "corePropertiesComplexType");
...
// FIELDS ------------------
    ...
    public FRBRthis getFRBRthis() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FRBRthis".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<FRBRuri> getFRBRuris() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FRBRuri".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<FRBRalias> getFRBRaliases() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FRBRalias".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<FRBRdate> getFRBRdates() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FRBRdate".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<FRBRauthor> getFRBRauthors() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("FRBRauthor".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public ComponentInfo getComponentInfo() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ComponentInfo".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public Preservation getPreservation() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Preservation".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
