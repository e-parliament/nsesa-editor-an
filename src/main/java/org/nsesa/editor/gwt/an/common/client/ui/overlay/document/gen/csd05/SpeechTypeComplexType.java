...
// CONSTRUCTORS ------------------
    ...
    public From getFrom() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("From".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
                result = (From) widget;
                break;
            }
        }
     ...
     * @return <code>SpeechTypeComplexType</code> instance
     */
    public SpeechTypeComplexType langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>SpeechTypeComplexType</code> instance
     */
    public SpeechTypeComplexType spaceAttr(final StringSimpleType spaceAttr) {
