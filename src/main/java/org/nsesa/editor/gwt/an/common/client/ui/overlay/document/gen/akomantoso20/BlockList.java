...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Item> getItems() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Item".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public ListConclusion getListConclusion() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ListConclusion".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public ListIntroduction getListIntroduction() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ListIntroduction".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
