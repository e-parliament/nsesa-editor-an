...
// CONSTRUCTORS ------------------
    ...
    public Caption getCaption() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Caption".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
     ...
     * @return <code>Table</code> instance
     */
    public Table langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>Table</code> instance
     */
    public Table spaceAttr(final StringSimpleType spaceAttr) {
