...
/**
 * this element is a hierarchical container called "section" either explicitly or due to the local<br/> tradition
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Section extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Section</code> object and set up its type
     */
    public Section() {
        super(create());
        setType("section");
     ...
     */
    public Section(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Section</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Section alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Section</code> instance
     */
    public Section langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Section</code> instance
     */
    public Section wildcardContentAttr(final String wildcardContentAttr) {
