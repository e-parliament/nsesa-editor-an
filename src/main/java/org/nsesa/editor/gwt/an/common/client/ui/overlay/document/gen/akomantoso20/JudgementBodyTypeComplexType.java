...
/**
 * the type judgementBodyType specifies a content model of the main hierarchy of a judgement<br/> document
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Introduction> getIntroductions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Introduction".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Background> getBackgrounds() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Background".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Motivation> getMotivations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Motivation".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Decision> getDecisions() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Decision".equalsIgnoreCase(widget.getType()) && "http://www.akomantoso.org/2.0".equalsIgnoreCase(widget.getNamespaceURI())) {
