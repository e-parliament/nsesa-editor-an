...
public class ScopeMod extends ModificationTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "scopeMod");
...
// CONSTRUCTORS ------------------
    ...
    public Domain getDomain() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Domain".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
