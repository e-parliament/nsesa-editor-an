...
/**
 * The element ul is an HTML element and is used in Akoma Ntoso as in HTML, for an unordered list of<br/> list item (elements li)
...
public class Ul extends ListItemsComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "ul");
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Ul</code> object and set up its type
     */
    public Ul() {
        super(create());
        setType("ul");
    ...
    /**
     * Create a <code>Ul</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Ul</code> instance
     */
    public Ul spaceAttr(final NCNameSimpleType spaceAttr) {
