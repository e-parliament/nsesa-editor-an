...
/**
 * the element docIntroducer is an inline element within preface to identify the string used by the<br/> document detailing the individual introducing of the document
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class DocIntroducer extends InlineComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "docIntroducer");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
        span.setClassName("widget docIntroducer");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>DocIntroducer</code> object and set up its type
     */
    public DocIntroducer() {
        super(create());
    ...
    /**
     * Create a <code>DocIntroducer</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> DocIntroducer</code> instance
     */
    public DocIntroducer alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> DocIntroducer</code> instance
     */
    public DocIntroducer classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> DocIntroducer</code> instance
     */
    public DocIntroducer evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> DocIntroducer</code> instance
     */
    public DocIntroducer periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> DocIntroducer</code> instance
     */
    public DocIntroducer spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> DocIntroducer</code> instance
     */
    public DocIntroducer styleAttr(final StringSimpleType styleAttr) {
     ...
     */
    @Override
    public DocIntroducer html(String s) {
        super.html(s);
        return this;
    }
}
