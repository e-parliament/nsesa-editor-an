...
public class RefItemsComplexType extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "refItemsComplexType");
...
// CONSTRUCTORS ------------------
    ...
    public java.util.List<Original> getOriginals() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Original".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<PassiveRef> getPassiveRefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("PassiveRef".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<ActiveRef> getActiveRefs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("ActiveRef".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<Jurisprudence> getJurisprudences() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Jurisprudence".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<HasAttachment> getHasAttachments() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("HasAttachment".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<AttachmentOf> getAttachmentOfs() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("AttachmentOf".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCPerson> getTLCPersons() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCPerson".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCOrganization> getTLCOrganizations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCOrganization".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCConcept> getTLCConcepts() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCConcept".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCObject> getTLCObjects() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCObject".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCEvent> getTLCEvents() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCEvent".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCLocation> getTLCLocations() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCLocation".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCProcess> getTLCProcesses() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCProcess".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCRole> getTLCRoles() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCRole".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCTerm> getTLCTerms() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCTerm".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
    ...
    public java.util.List<TLCReference> getTLCReferences() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("TLCReference".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
