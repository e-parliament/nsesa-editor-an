...
// CONSTRUCTORS ------------------
     ...
     * @return <code>CollectionStructureComplexType</code> instance
     */
    public CollectionStructureComplexType nameAttr(final StringSimpleType nameAttr) {
    ...
    public CollectionBody getCollectionBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("CollectionBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
