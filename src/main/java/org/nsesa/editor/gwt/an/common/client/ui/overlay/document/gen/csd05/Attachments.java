...
public class Attachments extends OverlayWidgetImpl {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Attachments</code> object and set up its type
     */
    public Attachments() {
        super(create());
        setType("attachments");
    ...
    /**
     * Create a <code>Attachments</code> object with the given DOM element
     */
     ...
     * @return <code>Attachments</code> instance
     */
    public Attachments langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code>Attachments</code> instance
     */
    public Attachments spaceAttr(final StringSimpleType spaceAttr) {
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    @Override
    public Attachments html(String s) {
        super.html(s);
        return this;
    }
}
