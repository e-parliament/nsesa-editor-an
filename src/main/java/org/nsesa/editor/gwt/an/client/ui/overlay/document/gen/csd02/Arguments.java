...
/**
* this element is a structural container for the section of a judgement containing the arguments
* This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
*/

public class Arguments extends MaincontentComplexType  {
...
span.setAttribute("type", "arguments");
span.setAttribute("ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02");
span.setClassName("widget arguments");
return span;
}

// CONSTRUCTORS ------------------
/**
* Create a <code>Arguments</code> object and set up its type
*/
public Arguments() {
super(create());
setType("arguments");
...
/**
* Create a <code>Arguments</code> object with the given DOM element
*/
...
//Override all attributes methods to be conformant with DSL approach
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments langAttr(final LanguageSimpleType langAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments spaceAttr(final NCNameSimpleType spaceAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments classAttr(final StringSimpleType classAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments styleAttr(final StringSimpleType styleAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments titleAttr(final StringSimpleType titleAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments wildcardContentAttr(final String wildcardContentAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments refersToAttr(final AnyURISimpleType refersToAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
        }
        /**
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments statusAttr(final StatusTypeSimpleType statusAttr) {
        ...
        * @return <code> Arguments</code> instance
        */
        public Arguments periodAttr(final AnyURISimpleType periodAttr) {
...
*/
@Override
public Arguments html(String s) {
    super.html(s);
    return this;
}
}
