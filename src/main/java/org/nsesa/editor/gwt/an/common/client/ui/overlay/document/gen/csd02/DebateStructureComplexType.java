...
/**
 * the type debateStructure specifies the overall content model of the document types that describe<br/> debates
...
// CONSTRUCTORS ------------------
    ...
    public DebateBody getDebateBody() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("DebateBody".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD02".equalsIgnoreCase(widget.getNamespaceURI())) {
