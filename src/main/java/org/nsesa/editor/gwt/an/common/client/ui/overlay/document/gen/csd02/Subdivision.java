...
/**
 * this element is a hierarchical container called "subdivision" either explicitly or due to the local<br/> tradition
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Subdivision extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Subdivision</code> object and set up its type
     */
    public Subdivision() {
        super(create());
        setType("subdivision");
     ...
     */
    public Subdivision(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Subdivision</code> object with the given DOM element
     */
    public Subdivision(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Subdivision alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Subdivision</code> instance
     */
    public Subdivision wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public Subdivision html(String s) {
        super.html(s);
        return this;
    }
}
