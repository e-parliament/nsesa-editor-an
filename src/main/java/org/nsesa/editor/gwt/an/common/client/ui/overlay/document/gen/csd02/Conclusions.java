...
/**
 * the element conclusion is used as a container of all concluding material (e.g. dates, signatures,<br/> formulas, etc.)
...
public class Conclusions extends BasicoptComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "conclusions");
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Conclusions</code> instance
     */
    public Conclusions spaceAttr(final NCNameSimpleType spaceAttr) {
