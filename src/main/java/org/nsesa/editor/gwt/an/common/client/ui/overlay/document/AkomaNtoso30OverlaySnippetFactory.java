 ...
 *         Date: 8/04/13 14:09
 */
public class AkomaNtoso30OverlaySnippetFactory extends DefaultOverlaySnippetFactory {
    ...
    @Inject
    public AkomaNtoso30OverlaySnippetFactory(@Named("html") final Transformer transformer,
