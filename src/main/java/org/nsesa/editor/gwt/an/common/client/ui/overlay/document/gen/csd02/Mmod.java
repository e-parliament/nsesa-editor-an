...
/**
 * the element mmod is an inline element containing multiple specifications of modifications on another<br/> document
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Mmod</code> object and set up its type
     */
    public Mmod() {
        super(create());
        setType("mmod");
     ...
     */
    public Mmod(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Mmod</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Mmod</code> instance
     */
    public Mmod wildcardContentAttr(final String wildcardContentAttr) {
