...
/**
 * The element original is a metadata reference to the Akoma Ntoso URI of the original version of this<br/> document (i.e., the first expression)
...
public class Original extends ReferenceTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "original");
...
// CONSTRUCTORS ------------------
     ...
     */
    public Original(AnyURISimpleType hrefAttr, IDSimpleType idAttr, StringSimpleType showAsAttr) {
        this();
