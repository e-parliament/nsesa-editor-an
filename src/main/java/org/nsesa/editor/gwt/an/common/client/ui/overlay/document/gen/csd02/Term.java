...
/**
 * The element term is an inline element to identify a text fragment introducing or referring to a term<br/> in the ontology
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Term extends InlinereqreqComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Term</code> object and set up its type
     */
    public Term() {
        super(create());
        setType("term");
    ...
    /**
     * Create a <code>Term</code> object with the given DOM element
     */
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Term</code> instance
     */
    public Term classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Term</code> instance
     */
    public Term periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Term</code> instance
     */
    public Term spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Term</code> instance
     */
    public Term styleAttr(final StringSimpleType styleAttr) {
