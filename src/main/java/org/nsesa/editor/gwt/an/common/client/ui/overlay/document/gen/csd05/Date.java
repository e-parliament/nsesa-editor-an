...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Date</code> object and set up its type
     */
    public Date() {
        super(create());
        setType("date");
     ...
     */
    public Date(AnySimpleTypeSimpleType dateAttr) {
        this();
    ...
    /**
     * Create a <code>Date</code> object with the given DOM element
     */
    ...
    // FIELDS ------------------
    private AnySimpleTypeSimpleType dateAttr;
     ...
     * @return dateAttr
     */
    public AnySimpleTypeSimpleType getDateAttr() {
        if (dateAttr == null) {
            dateAttr = new AnySimpleTypeSimpleType();
     ...
     * @return dateAttr
     */
    public AnySimpleTypeSimpleType dateAttr() {
        return getDateAttr();
    }
     ...
     */
    public void setDateAttr(final AnySimpleTypeSimpleType dateAttr) {
     ...
     */
    public Date dateAttr(final AnySimpleTypeSimpleType dateAttr) {
        setDateAttr(dateAttr);
        return this;
    }
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> Date</code> instance
     */
    public Date alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Date</code> instance
     */
    public Date langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Date</code> instance
     */
    public Date wildcardContentAttr(final String wildcardContentAttr) {
