...
public class BlockContainer extends BlockContainerTypeComplexType {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "blockContainer");
        span.setAttribute("data-ns", "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05");
        span.setClassName("widget blockContainer");
        return span;
    }
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>BlockContainer</code> object and set up its type
     */
    public BlockContainer() {
        super(create());
        setType("blockContainer");
    }

    /**
     * Constructor with required attributes
     */
    public BlockContainer(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>BlockContainer</code> object with the given DOM element
     */
    public BlockContainer(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer langAttr(final StringSimpleType langAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer spaceAttr(final StringSimpleType spaceAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> BlockContainer</code> instance
     */
    public BlockContainer wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public BlockContainer html(String s) {
        super.html(s);
        return this;
    }
}
