...
public class Components extends OverlayWidgetImpl {
    ...
    public static Element create() {
        ...
        span.setAttribute("data-type", "components");
...
// FIELDS ------------------
    ...
    public java.util.List<Component> getComponents() {
        ...
        for (OverlayWidget widget : getChildOverlayWidgets()) {
            if ("Component".equalsIgnoreCase(widget.getType()) && "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD05".equalsIgnoreCase(widget.getNamespaceURI())) {
