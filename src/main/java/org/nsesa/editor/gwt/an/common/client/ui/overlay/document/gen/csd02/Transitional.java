...
/**
 * this element is a hierarchical container called "transitional" either explicitly or due to the local<br/> tradition
 * This file is generated. Rather than changing this file, correct the template called <tt>overlayClass.ftl</tt>.
 */

public class Transitional extends HierarchyComplexType {
...
// CONSTRUCTORS ------------------
    ...
    /**
     * Create a <code>Transitional</code> object and set up its type
     */
    public Transitional() {
        super(create());
     ...
     */
    public Transitional(IDSimpleType idAttr) {
        this();
        setIdAttr(idAttr);
    }
    ...
    /**
     * Create a <code>Transitional</code> object with the given DOM element
     */
    public Transitional(Element element) {
        super(element);
    }
...
//Override all attributes methods to be conformant with DSL approach
     ...
     */
    public Transitional alternativeToAttr(final AnyURISimpleType alternativeToAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional classAttr(final StringSimpleType classAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional evolvingIdAttr(final NMTOKENSimpleType evolvingIdAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional idAttr(final IDSimpleType idAttr) {
        setIdAttr(idAttr);
        return this;
    }
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional langAttr(final LanguageSimpleType langAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional periodAttr(final AnyURISimpleType periodAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional refersToAttr(final AnyURISimpleType refersToAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional spaceAttr(final NCNameSimpleType spaceAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional statusAttr(final StatusTypeSimpleType statusAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional styleAttr(final StringSimpleType styleAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional titleAttr(final StringSimpleType titleAttr) {
     ...
     * @return <code> Transitional</code> instance
     */
    public Transitional wildcardContentAttr(final String wildcardContentAttr) {
     ...
     */
    @Override
    public Transitional html(String s) {
        super.html(s);
        return this;
    }
}
