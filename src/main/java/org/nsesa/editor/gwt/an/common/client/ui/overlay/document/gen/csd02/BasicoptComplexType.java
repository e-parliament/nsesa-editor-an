...
/**
* Create a <code>BasicoptComplexType</code> object with the given DOM element
*/
...
// FIELDS ------------------
    ...
    private AnyURISimpleType periodAttr;
        ...
        * @param alternativeToAttr the new value
        * @return <code>BasicoptComplexType</code> instance
        */
        ...
        * @return <code>BasicoptComplexType</code> instance
        */
        public BasicoptComplexType spaceAttr(final NCNameSimpleType spaceAttr) {
...
*/
@Override
public BasicoptComplexType html(String s) {
    super.html(s);
    return this;
}
}
